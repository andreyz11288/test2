  ...
  return (
    <main>
      ...
      <div className="container">
        ...
        <div className="containerTabs"><div id='tabsLink1' className='tabs activeTabs'><div className='containerTabs1 '>
          ...
          <div className='img1'><img src={img1} alt='img1' /></div>
        </div>
        <div id='tabsLink2' className='tabs'><div className='containerTabs2'>
          <div  className='tabsLink2' onClick={() => {setTabs('tabs2')}}><h2>Sequence once, query often</h2>
          <img src={copy} alt='copy' /></div>
         <div  className='contentTabs2'> <Future2 /></div>
        </div>
        <div  className='img2'><img src={img2} alt='img2' /></div>
        </div>
        <div id='tabsLink3' className='tabs '><div className='containerTabs3'>
